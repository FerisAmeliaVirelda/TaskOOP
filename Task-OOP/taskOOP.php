...
echo "<br/>";
$persegi = new Persegi();
echo "Bangun datar ini adalah " .$persegi->NamaBangun(), " yang memiliki luas " .$persegi->LuasPersegi(5), " dan keliling " .$persegi->KelilingPersegi(5);
echo "<br/>";
$persegipanjang = new PersegiPanjang();
echo "Bangun datar ini adalah " .$persegipanjang->NamaBangun(), " yang memiliki luas " .$persegipanjang->LuasPersegiPanjang(5,10), " dan keliling " .$persegipanjang->KelilingPersegiPanjang(5,10);
echo "<br/>";
